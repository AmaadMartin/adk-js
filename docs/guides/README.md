...
- [LlmAsJudge](evaluation/llm_as_judge/index.md) - Grading an agent's
  ...
  sample are handled.
- [Grading a user simulator](evaluation/per_turn_user_simulator_quality_v1/index.md) -
  Scoring the simulated user in a multi-turn eval case, turn by turn, against
