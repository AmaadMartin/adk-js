...
- [Gemini context caching](models/context_caching/index.md) - Creating,
  reusing and deleting a Gemini explicit context cache, and the evidence the
  manager needs before it creates one.
