...
- [GoogleApiToolset](tools/google_api_toolset/index.md) - Turning a Google API Discovery document into authenticated tools, with their scopes, credentials and headers.
