...
- [Environment simulation config](tools/environment_simulation_config/index.md) - Describing a simulated tool environment: mock strategies, error and response injection, and the deprecated agent_simulator alias.
