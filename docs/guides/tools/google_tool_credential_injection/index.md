# GoogleTool with credential injection

> This branch carries two ports of `GoogleTool`. This one injects the
> credential and the settings as call arguments. The package barrel exports it
> as `CredentialInjectingGoogleTool`, because the other port
> ([GoogleTool](../google_tool/index.md)) holds the plain name.
