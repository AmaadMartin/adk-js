...
```ts
import {GoogleTool, GoogleToolCredentialsConfig} from '@google/adk';
import {z} from 'zod/v3';

const credentialsConfig = new GoogleToolCredentialsConfig({
...
`GoogleToolCredentialsConfig` takes exactly one credential source. Any other
