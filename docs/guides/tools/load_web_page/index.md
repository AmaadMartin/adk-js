...
| `http://[64:ff9b::169.254.169.254]/` | An IPv6 address that wraps a blocked IPv4 address is blocked. The NAT64, IPv4-mapped and IPv4-compatible forms are unwrapped and the address inside them is checked. |
| `http://[2002:5db8:d822::]/`         | The 6to4 prefix `2002::/16` is refused as a whole, even when it wraps a public IPv4 address.                                                                         |
