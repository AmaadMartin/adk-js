...
// `GcsCredentialsConfig` is the second port of the same adk-python class, on
// `tools/google_credentials.js`. The cases below are ported from adk-python
// `main`, `tests/unittests/integrations/gcs/test_gcs_credentials.py`.
describe('GcsCredentialsConfig', () => {
  it('test_gcs_credentials_config_client_id_secret', () => {
    const config = new GcsCredentialsConfig({
      clientId: 'abc',
