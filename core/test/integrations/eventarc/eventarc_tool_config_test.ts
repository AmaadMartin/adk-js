 ...
 */
function createFromJson(json: string): ValidatedEventarcToolConfig {
...
describe('Eventarc tool config', () => {
  ...
  describe('createEventarcToolConfig', () => {
    ...
    // An explicit `undefined` is legal against
    // `Partial<ValidatedEventarcToolConfig>`,
    ...
    it('returns a fresh object, not the caller object', () => {
      const params: Partial<ValidatedEventarcToolConfig> = {
