...
describe('Bigtable Metadata Tool', () => {
  ...
  it('listInstances returns instances', async () => {
    ...
    expect(expectSuccess(await metadataTool.listInstances(client))).toEqual([
      {
        project_id: 'proj-1',
        instance_id: 'inst1',
        display_name: 'Inst 1',
  ...
  it('listTables returns the tables', async () => {
    ...
    expect(
      expectSuccess(await metadataTool.listTables(client, 'inst1')),
    ).toEqual([
      {
        project_id: 'proj-1',
        instance_id: 'inst1',
  ...
  it('listClusters returns the clusters', async () => {
    ...
    expect(
      expectSuccess(await metadataTool.listClusters(client, 'inst1')),
    ).toEqual([
      {
        project_id: 'proj-1',
        instance_id: 'inst1',
