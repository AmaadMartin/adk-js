...
// The barrel prefixes these names, because a second port of each already holds
// the plain name. This test drives this port, so it imports the modules direct.
import {
  BaseGoogleCredentialsConfig,
  GoogleCredentialsManager,
} from '../../src/tools/google_credentials.js';
import {GoogleTool} from '../../src/tools/google_tool_credential_injection.js';
