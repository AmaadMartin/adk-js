...
describe('TransferToAgentTool', () => {
  ...
  it('constrains agentName in a parametersJsonSchema declaration', () => {
  ...
  it('leaves a parametersJsonSchema without agentName untouched', () => {
  ...
  it('rejects a call whose agentName is missing', async () => {
    ...
    expect(result).toEqual({
      error:
        'Invoking `transfer_to_agent()` failed as the following mandatory input parameters are not present:\n' +
        'agentName\n' +
