...
import type {AuthCredential, Context} from '../../../src/index.js';
import {AuthCredentialTypes, ToolAuthHandler} from '../../../src/index.js';
...
const API_KEY_SCHEME = createApiKeyScheme('X-API-Key', 'header');
