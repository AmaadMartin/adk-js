...
/**
 * Cases the adk-python suite for `user_simulator_personas` leaves open: empty
 * and single-entry bullet lists, entries the formatter must not rewrite, the
 * order and the freshness of the registered persona list, and the debug line
 * an overwrite writes.
 */
