...
// Ports the TestMultiTurnVertexAiEvalFacade tests of
// tests/unittests/evaluation/test_vertex_ai_eval_facade.py of
// google/adk-python at main. The private mapping helpers the reference calls
// directly are asserted here through the request the client receives.
