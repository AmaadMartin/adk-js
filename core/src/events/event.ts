...
import {contentUnionToUserContent} from '../utils/content_utils.js';
...
import {createEventActions, mergeEventActions} from './event_actions.js';
...
export function createEvent(params: CreateEventParams = {}): Event {
  ...
  return {
    ...
    content:
      message !== undefined ? contentUnionToUserContent(message) : rest.content,
...
export function setEventMessage(
  ...
  event.content =
    value === undefined || value === null
      ? undefined
      : contentUnionToUserContent(value);
}
