 ...
 * @returns True if the object is a BasePlanner, false otherwise.
 */
...
export abstract class BasePlanner {
   ...
   * @returns The planning system instruction, or undefined when the planner
   ...
   * @returns The processed response parts, or undefined when the planner needs
   *     no processing.
   */
