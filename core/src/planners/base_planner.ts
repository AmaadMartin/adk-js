...
/**
 * Parameters for {@link BasePlanner.buildPlanningInstruction}.
 */
export interface BuildPlanningInstructionParams {
  /** The readonly context of the invocation. */
  readonlyContext: ReadonlyContext;

  /** The LLM request. Readonly to the planner. */
  llmRequest: LlmRequest;
}

/**
 * Parameters for {@link BasePlanner.processPlanningResponse}.
 */
...
export abstract class BasePlanner {
   ...
   * planning.
   *
   * @param params The readonly context and the LLM request.
   * @returns The planning system instruction, or undefined if no instruction
   *     is needed.
   */
   ...
   *
   * @param params The callback context and the LLM response parts.
