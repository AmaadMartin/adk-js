 ...
 * A leftover process would also hold the exec's output open.
 *
 ...
 *
 * The supervisor runs the command through `execvp` rather than reading it, so
 * the real interpreter sets `sys.argv` and reports traceback line numbers.
 *
