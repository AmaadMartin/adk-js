...
import type {SourceIdentity, TranscriptEvent} from './rag_memory_transcript.js';
import {
...
import type {RagApiClient, RagContext} from './vertex_ai_rag_api.js';
import {VertexRagApiClient} from './vertex_ai_rag_api.js';
