 ...
 * `actions.setModelResponse` for the flow to promote. The promoted event is a
 * final response, so no further model turn rewrites the accepted answer and the
 * tool needs no `skipSummarization` of its own.
 *
