...
/**
 * Creates {@link BigtableToolSettings} with the default row cap applied.
 *
 * @param params Optional partial {@link BigtableToolSettings}.
 * @returns The settings with `maxQueryResultRows` resolved.
