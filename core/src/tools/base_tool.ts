...
export abstract class BaseTool {
   ...
   *
   * ADK-internal. Subclasses opt in with
   * `override readonly defersResponse = true;`, which only compiles because of
   * the explicit `boolean` annotation below. Mirrors adk-python's
   * `BaseTool._defers_response`.
   */
