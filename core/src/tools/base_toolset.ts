...
export abstract class BaseToolset {
   ...
   * @param context Context used to filter tools available to the agent. Only a
   *     {@link ToolPredicate} filter reads it. Without one the predicate cannot
   *     run, and the tool is selected.
