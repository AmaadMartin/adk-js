...
// Node only: the BigQuery tools load `@google-cloud/bigquery` and
// `@google-cloud/dataplex`, so they are not exported from `common.ts`,
// which the web build serves.
export * from './tools/bigquery/index.js';
