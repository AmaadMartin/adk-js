 ...
 *
 * This is the pass for a URI that is being stored. It fails closed, so the
 * result may not be readable. For a URI going into a log line or an error
 * message, where the location has to stay legible, use
 * {@link redactUriPassword} instead.
 *
 ...
 * use {@link sanitizeExternalUri} instead.
 */
