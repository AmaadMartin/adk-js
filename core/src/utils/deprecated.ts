 ...
 *
 * `key` identifies the deprecated item, so one deprecation never silences
 * another. Use this for a deprecated function or entry point, and
 * {@link deprecated} for a deprecated class.
 */
