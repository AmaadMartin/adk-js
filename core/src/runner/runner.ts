...
export class Runner {
  ...
  /**
   * Closes the toolsets the runner's root declares.
   *
   * A failure to close one toolset does not stop the others, and none of them
   * fails the run that is ending.
   */
  ...
  /**
   * Releases the resources this runner holds.
   *
