...
export interface RunnerConfig {
  ...
  /** Optional default user ID for invocations executed by this runner. */
  userId?: string;

  /** Optional default session ID for invocations executed by this runner. */
  sessionId?: string;

  /** Optional default run configuration for invocations executed by this runner. */
  runConfig?: RunConfig;
}
...
export class Runner {
  ...
  async *runEphemeral(params: {
    ...
    const runConfig = params.runConfig ?? this.runConfig;
