...
/**
 * The configuration a caller gets when it enables context caching without
 * tuning it.
 */
...
/**
 * Renders the time-to-live in the duration format the cache API accepts.
 *
 * @param config The configuration to read the time-to-live from.
 * @returns The time-to-live as a seconds duration, for example `1800s`.
 */
