...
> extends BaseNode {
   ...
   * default throws so an unsupported live run fails loudly instead of
   * completing silently.
   *
   * @param _context The invocation context of the agent.
   * @yields The events generated by the agent.
   * @returns An AsyncGenerator that yields the events generated by the agent.
   */
  // eslint-disable-next-line require-yield -- the AsyncGenerator signature is mandated by runLive(); this default has nothing to emit.
