...
> {
   ...
   *
   * Subclasses that support live (bidi-streaming) runs override this. The
   * default throws so that an agent without live support fails loudly instead
   * of silently completing a live run with no events.
   *
   * @param _context The invocation context of the agent; unused by the
   *   default implementation.
   * @yields The events generated by the agent.
   * @returns An AsyncGenerator that yields the events generated by the agent.
   */
  // eslint-disable-next-line require-yield -- the AsyncGenerator return type is mandated by runLive(); this default reports that live is unimplemented and has nothing to emit.
