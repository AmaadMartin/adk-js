 ...
 * whatever prefix the request marks, and a model reached through LiteLLM
...
/**
 * The longest prefix cache a prefix-marking provider offers is an hour, and it
...
/**
 * Returns the cache config governing this request, or `undefined` when the
