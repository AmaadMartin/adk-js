...
// merge. Faithful subset of adk-python `evaluation/eval_case.py`: only the
// invocation/intermediate-data shapes and tool-call helpers this sub-port
// depends on. The eval-case/session models owned by #2 are intentionally
// omitted here.
