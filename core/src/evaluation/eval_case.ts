...
/**
 * A single point in an agent's invocation: a reply, a tool call, a result.
 *
 * This is a projection of the runtime `Event` model, reduced to the fields the
 * evaluation system reads.
 */
