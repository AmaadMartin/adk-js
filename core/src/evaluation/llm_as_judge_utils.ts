...
/**
 * Returns the mean of the rubric scores that carry a score.
 *
 * Returns `undefined` when none of them does, so that a set of rubrics the
 * judge could not assess reads as unscored rather than as zero.
 */
