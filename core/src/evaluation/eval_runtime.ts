 ...
 * {@link setEvalRuntime}, once it is ported. {@link EvalServiceParams} carries
 * the eval config whole rather than the metrics alone, because the service
 * also reads its live-model settings.
 *
