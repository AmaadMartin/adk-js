...
/**
 * The metric vocabulary an evaluation speaks. This file currently holds the
 * prebuilt metric names and the descriptor a `MetricInfoProvider` returns. The
 * criteria, the judge model options and the result models of adk-python's
 * `eval_metrics.py` arrive with the code that reads them.
 */
