...
const MEMORY_SERVICE_URI_OPTION = new Option(
  '--memory_service_uri <string>',
  'Optional. The URI of the memory service. Supported URIs: memory:// for the in-memory service, agentengine://<resource id or full resource name> for Vertex AI Agent Engine Memory Bank.',
);
