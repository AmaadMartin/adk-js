 ...
 * declares `agent_name`; the adk-js built-in declares `agentName`. The loader
 * keeps recorded tool arguments verbatim, so accept either spelling.
 */
export function transferTargetAgentName(
  toolArgs: Record<string, unknown>,
): string | undefined {
  const agentName = toolArgs['agent_name'] ?? toolArgs['agentName'];
