...
async function recordOneTurn(
  plugin: ConformanceRecordingPlugin,
...
describe('ConformanceRecordingPlugin when recording is off', () => {
...
describe('ConformanceRecordingPlugin state guards', () => {
...
describe('ConformanceRecordingPlugin recording a run', () => {
...
describe('ConformanceRecordingPlugin skipping what it cannot record', () => {
...
describe('ConformanceRecordingPlugin reading the fixture it appends to', () => {
